...
function(parquet_install_cmake_package PACKAGE_NAME EXPORT_NAME)
  set(CONFIG_CMAKE "${PACKAGE_NAME}Config.cmake")
  set(BUILT_CONFIG_CMAKE "${CMAKE_CURRENT_BINARY_DIR}/${CONFIG_CMAKE}")
  configure_package_config_file("${CONFIG_CMAKE}.in" "${BUILT_CONFIG_CMAKE}"
                                INSTALL_DESTINATION "${PARQUET_INSTALL_CMAKEDIR}/${PACKAGE_NAME}"
  )
  ...
  install(FILES "${BUILT_CONFIG_CMAKE}" "${BUILT_CONFIG_VERSION_CMAKE}"
          DESTINATION "${PARQUET_INSTALL_CMAKEDIR}/${PACKAGE_NAME}")
...
function(add_parquet_lib LIB_NAME)
  set(options)
  set(one_value_args
      BUILD_SHARED
      BUILD_STATIC
  ...
  # Allow overriding PARQUET_BUILD_SHARED and PARQUET_BUILD_STATIC
  if(DEFINED ARG_BUILD_SHARED)
    set(BUILD_SHARED ${ARG_BUILD_SHARED})
  else()
    set(BUILD_SHARED ${PARQUET_BUILD_SHARED})
  endif()

  if(DEFINED ARG_BUILD_STATIC)
    set(BUILD_STATIC ${ARG_BUILD_STATIC})
  else()
    set(BUILD_STATIC ${PARQUET_BUILD_STATIC})
  endif()
  ...
  if(BUILD_SHARED)
    ...
    target_link_libraries(${LIB_NAME}_shared
                          PUBLIC "$<BUILD_INTERFACE:parquet_sanitizer_flags>")

    install(TARGETS ${LIB_NAME}_shared
            EXPORT parquet_targets
...
function(parquet_install_all_headers PATH)
  set(options)
  set(one_value_args)
  ...
  install(FILES ${PUBLIC_HEADERS} DESTINATION "${PARQUET_INSTALL_INCLUDEDIR}/${PATH}")
endfunction()
